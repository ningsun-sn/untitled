...
class Game2048PanelState extends State<Game2048Panel> {
  ...
  Widget _buildGameCell(int value) {
    return Container(
      decoration: BoxDecoration(
        color: ColorUtils.mapValueToColor(value),
      ...
      child: Center(
        child: Text(
          ...
          style: TextStyle(
            color:
            value == 2 || value == 4 ? ColorUtils.textColor1 : ColorUtils.textColor3,
  ...
  Widget _buildGameOverMask(BuildContext context) {
    return _buildGameFrame(
        ...
        Container(
          decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(10),
            color: ColorUtils.bgColor1.withOpacity(0.5),
          ),
          child: Center(
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                    style: ButtonStyle(
                      backgroundColor:
                      MaterialStateProperty.all<Color>(ColorUtils.bgColor3),
                    ),
                    onPressed: () {
                      reStartGame();
                    },
